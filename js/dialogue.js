const lines = {
  ...
  hint2: "Can you spot one clue?",
  hint3: "Let's do one small step together.",
  ...
  newSkill: "Let's discover something new!",
  practice: "Let's practice this one together.",
...
export function responseFor({ correct, attempts = 0 }) {
  ...
  if (attempts <= 1) return say("hint");
  if (attempts === 2) return say("hint2");
  return say("hint3");
}
