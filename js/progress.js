...
export function recordMission(progress, missionId) {
  const day = new Date().toISOString().slice(0, 10);
  progress.missions[day] ||= {};
  if (progress.missions[day][missionId]) return false;
  progress.missions[day][missionId] = true;
  saveProgress(progress);
  return true;
}
