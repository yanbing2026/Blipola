export function getHint(context={}) {
  if(context.level>=4) return "Let's solve one tiny part together.";
...
export function getExplanation(){ return "Let's break the idea into one small step."; }
export function getHintLevel(wrongAttempts=0){ return Math.min(4,Math.max(0,wrongAttempts)); }
